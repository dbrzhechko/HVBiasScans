...
if __name__ == "__main__":
	...
	if is_dates:
		...
		ldr_ns = {1:5,2:5,4:6}
		mod_ns = [1,2,4]
		f1 = [[200, 600], [200, 600], [200, 600], [200, 600], [200, 600]]
		f2 = [[200, 600], [200, 600], [200, 600], [200, 600], [200, 600]]
		for modx in mods:
			filenames = ["HVscan_2018.root"] 
			files_dates = []
			...
			for n in range(0,len(dates)):
				histonames.append(
					"AvgNormOnTrkCluCharge_vs_BiasVoltage/HV%s_BmO_SEC2_LYR%s_LDR%s_MOD%s" % (bias_scan_num[n], laydisk[1], ldr_ns[modx], modx))
			# files_dates = ["HVscan_2018.root"]
			...
			other_pars = {
				"initpars": 
				{	
					"2018-08-17 12:00:00": [25, 250, 100, 0.01, 0], 
					"2018-09-01 12:00:00": [25, 250, 100, 0.01, 0],
					"2018-09-07 12:00:00": [25, 250, 100, 0.01, 0], 
					"2018-09-26 12:00:00": [25, 250, 100, 0.01, 0],
					"2018-10-20 12:00:00": [25, 250, 100, 0.01, 0],
				},
				"pars_limits":
				{	
					"2018-08-17 12:00:00": [[10,30], [100,250], [20,150], [0.,0.01], [-5, 10]],
					"2018-09-01 12:00:00": [[10,30], [100,250], [20,150], [0.,0.01], [-5, 10]],
					"2018-09-07 12:00:00": [[10,30], [100,250], [20,150], [0.,0.01], [-5, 10]],
					"2018-09-26 12:00:00": [[10,30], [100,250], [20,150], [0.,0.01], [-5, 10]],
					"2018-10-20 12:00:00": [[10,30], [100,250], [20,150], [0.,0.01], [-5, 10]],
				},
				"is_par_limit":
				{
					"2018-08-17 12:00:00": [False,False,False,True,True],
					"2018-09-01 12:00:00": [False,False,False,True,True],
					"2018-09-07 12:00:00": [False,False,False,True,True],
					"2018-09-26 12:00:00": [False,False,False,True,True],
					"2018-10-20 12:00:00": [False,False,False,True,True],
				},
				"Vdepl_ref_values": {
					"2018-08-17 12:00:00": [-428.7565949010766, -61.35170411928435],
					"2018-09-01 12:00:00": [-428.7565949010766, -61.35170411928435],
					"2018-09-07 12:00:00": [-428.7565949010766, -61.35170411928435],
					"2018-09-26 12:00:00": [-428.7565949010766, -61.35170411928435],
					"2018-10-20 12:00:00": [-428.7565949010766, -61.35170411928435],
				},
			# "funcs":{
